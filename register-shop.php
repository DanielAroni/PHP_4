...
<head>
	...
	<title>Tienda Web | Registro</title>
...
<body>
	...
	<div class="wrapper" style="background-image: url(images/Imagen2.jpg);">
		<div class="container" >
			<div class="row">
					...
					<form class="form-vertical" action="action/new-shop.php" method="POST">
						...
						<div class="module-body">
							...
							<div class="control-group">
								...
								<option value="">Por favor seleccione su Moneda</option>
								<?php
                              ...
                              if ($result->num_rows > 0) {
                               ...
                               print '<option value="'.$row['iso'].'">'.$row['currency'].' - '.$row['iso'].'</option>';
								...
								<option value="">Por favor seleccione su Zona Horaria</option>
                              ...
                              if ($result->num_rows > 0) {
                               ...
                               print '<option value="'.$row['timezone'].'">'.$row['timezone'].'</option>';
								...
								?>
														...
														<div class="control-group">
								<div class="controls row-fluid">
									<input class="span12" type="text" id="txt:pedido" placeholder="Pedido" name="pedido" required>
