...
<head>
    <head>
        ...
        <title>Tienda Web | Configuracion de Cuenta</title>
            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="#">Tienda Web</a>
                    <div class="nav-collapse collapse navbar-inverse-collapse">
                                                <form class="navbar-search pull-left input-append" action="action/search_product.php" method="POST">
                        <input type="text" class="span3" placeholder="Buscar Producto....." name="product" required>
                    ...
                    <div class="span9">
                        <div class="content">
							...
							?>
                                ...
                                <div class="profile-tab-content tab-content">
                                    <div class="tab-pane fade active in" id="activity">
										...
										<div class="control-group">
											<label class="control-label" for="basicinput">Nombre de la Tienda</label>
											<div class="controls">
								...
								<option value="">Por favor seleccione la Moneda</option>
								<?php
								include '../config/db_config.php';
                              ...
                              if ($result->num_rows > 0) {
							   ...
							   echo "selected";
								...
								<option value="">Por favor seleccione la Zona Horaria</option>
                              ...
                              if ($result->num_rows > 0) {
                               ...
                               print '<option '; if ($shop_timezone == $row['timezone']){print ' selected ';} print' value="'.$row['timezone'].'">'.$row['timezone'].'</option>';
								...
								?>
										...
										<div class="control-group">
											<label class="control-label" for="basicinput">Dirrecion de la Tienda</label>
											<div class="controls">
										...
										<div class="control-group">
											<label class="control-label" for="basicinput">Telefono de la Tienda</label>
											<div class="controls">
										...
										<div class="control-group">
												                      <div class="controls">
												<button type="submit" class="btn">Actualizar Informacion</button>
											</div>
										</div><br>
									</form>
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="friends">
										...
										<div class="control-group">
											<label class="control-label" for="basicinput">Confirmar la Contraseña</label>
											<div class="controls">
