...
<head>
    <head>
        ...
        <title>Tienda Web | Editar Productos</title>
                            ...
                            <div class="module">
								...
								?>
                                 <form class="form-horizontal row-fluid" action="action/update-stock.php" method="POST">
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<b style="color:red;">Cambie esto solo si está actualizando el producto</b>
																				...
																				<div class="control-group">
											<label class="control-label" for="basicinput">Codigo de Barras</label>
											<div class="controls">
										...
										<div class="control-group">
											<label class="control-label" for="basicinput">Producto por Unidad</label>
											<div class="controls">
										...
										<div class="control-group">
											<label class="control-label" for="basicinput">Fecha de Expiracion</label>
											<div class="controls">
