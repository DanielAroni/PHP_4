...
<head>
    <head>
        ...
        <title>Tienda Web | Agregar Ventas</title>
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<div class="input-prepend">
													<span class="add-on">#</span><input class="span8" type="number" name="ammount1" placeholder="Monto">       
												</div>
											</div>
											...
											<div class="controls">
												...
												<div class="input-prepend">
													<span class="add-on">#</span><input class="span8" type="number" name="ammount2" placeholder="Monto">       
												</div>
											</div>
											...
											<div class="controls">
												...
												<div class="input-prepend">
													<span class="add-on">#</span><input class="span8" type="number" name="ammount3" placeholder="Monto">       
												</div>
											</div>
											...
											<div class="controls">
												...
												<div class="input-prepend">
													<span class="add-on">#</span><input class="span8" type="number" name="ammount4" placeholder="Monto">       
												</div>
											</div>
											...
											<div class="controls">
												...
												<div class="input-prepend">
													<span class="add-on">#</span><input class="span8" type="number" name="ammount5" placeholder="Monto">       
												</div>
											</div>
